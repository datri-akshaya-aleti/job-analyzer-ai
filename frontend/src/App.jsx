            ...
            {result && (
              ...
              {result.skills_found && result.skills_missing && (
                    ...
                    {Object.entries(result.breakdown).map(([key, value]) => (
                      <div key={key} style={{ marginBottom: "12px" }}>
                        <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "4px" }}>
                          <span style={{ color: "#9ca3af", fontSize: "0.85rem", textTransform: "capitalize" }}>{key.replace(/_/g, " ")}</span>
                          <span style={{ color: getScoreColor(value), fontSize: "0.85rem", fontWeight: "700" }}>{value}%</span>
                        </div>
                ...
                <div style={{ textAlign: "center", marginBottom: "20px" }}>
                  <button onClick={() => { setResult(null); setFile(null); setJobDescription(""); setPrepData({}); window.scrollTo(0, 0); }} className="submit-btn" style={{ width: "300px" }}>
                          ...
                          <div style={{ marginTop: "20px", borderTop: "1px solid rgba(99,102,241,0.2)", paddingTop: "20px" }}>
                            ...
                            <div style={{ marginBottom: "16px" }}>
                              ...
                              {prepData[i].hiring_process.map((step, j) => (
                                <p key={j} style={{ color: "#9ca3af", fontSize: "0.85rem", marginBottom: "6px", lineHeight: "1.5" }}>{step}</p>
                              ))}
                            </div>
                            <div style={{ marginBottom: "16px" }}>
                              ...
                              {prepData[i].interview_tips.slice(0, 4).map((tip, j) => (
                                <p key={j} style={{ color: "#9ca3af", fontSize: "0.85rem", marginBottom: "6px", lineHeight: "1.5" }}>✅ {tip}</p>
                              ))}
                            </div>
